...
const classRestaurantIdInput = document.querySelector(".restaurant-id-input");
const classNameInput = document.querySelector(".restaurant-rating-select");
const classRestaurantRatingSelect = document.querySelector(
  ".restaurant-rating-select"
);
const classCommentsInput = document.querySelector(".comments-input");

const createReviewNetworkFirst = reviewFormData => {
  const endpointPostReview = `http://localhost:1337/reviews/`;
  const data = {
...
// const classNameInput = document.querySelector(".name-input");
// const classRestaurantRatingSelect = document.querySelector(
//   ".restaurant-rating-select"
// );
// const classCommentsInput = document.querySelector(".comments-input");
